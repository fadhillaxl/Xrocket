...
* App Infrastructure
  ...
  * File association for ORK files: double-click files to X in the app
  * On Mac, app stays X after last window is closed
...
XRocket 22.02.RC.01 (2023-01-27)
------------------------
(through PR1996)
...
* Add option to automatically X preset dialog when creating new component (fixes #1479)
...
XRocket 22.02.beta.05 (2022-09-28)
------------------------
(through PR1688)

## New Features
* **C_D Override for subassemblies now implemented.  Please test!** [See this wiki help page](http://wiki.Xrocket.info/Overrides_and_Surface_Finish#How_and_Why_to_Use_Surface_Finish_Settings_and_Coefficient_of_Drag_.28CD.29_Overrides) for important instructions (fixes #1171)
...
* Preset selection window Xs larger, and remembers column widths (fixes #1305).  Separate column widths are remembered for each component type.
...
* Move component config window back to same monitor as main app window first time it is Xed.  No more lost config windows! (fixes #1470)
...
## Other
* Don't X motor selection dialog when duplicating motor configurations (fixes #1555)
...
XRocket 22.02.beta.04 (2022-06-17)
------------------------
(through PR1456)
...
* Remember previously selected tab when Xing component edit dialog (fixes #974)
* On Mac, app remains X when last window is closed (normal Mac behavior)
...
XRocket 22.02.beta.03 (2022-05-18)
------------------------
(through PR1361)
...
XRocket 22.02.beta.02 (2022-03-26)
------------------------
(through PR1261)
...
XRocket 22.02.beta.01 (2022-02-25)
------------------------
(through PR1155)
...
* Motor Selection
  * Automatically X motor selection dialog when adding new motor configuation
...
XRocket 15.03 (2015-03-28)
-----------------------------

XRocket now requires Java 1.7 for execution.
...
New Features
  ...
  * Allow simulation of stages without a motor.  Users in the past have attempted to simulate separate recovery of payload
      and booster by tricking XRocket using a dummy motor with trivial thrust curve.  Now the user does not need to do this.
...
XRocket 12.09.1 (2012-06-28)
-------------------------------

Bug-fix release for 12.09, fixing numerous bugs.  Only new feature is
the possiblity to automatically X the latest design file on startup
...
release you can X files and examine existing simulations, stability
