...
public class AboutDialog extends JDialog {
	...
	private final String CREDITS = "<html><center>" +
		...
		"<br>" +
		"See all contributors at <br>" + href("https://github.com/XRocket/XRocket/graphs/contributors", false, false) + "<br>" +
		"<br>" +
		"<b>XRocket utilizes the following libraries:</b><br>" +
		"<br>" +
		...
		"<br>" +
		"<b>XRocket gratefully acknowledges our use of the following databases:</b><br>" +
		"<br>" +
		"Rocket Motor Data" + href("https://www.thrustcurve.org", true, true) + "<br>" +
		"Enhanced components database for XRocket" + href("https://github.com/dbcook/openrocket-database", true, true) +
		"</center></html>";
	...
	public AboutDialog(JFrame parent) {
		...
		// OpenRocket logo
		panel.add(new JLabel(Icons.loadImageIcon("pix/icon/icon-128.png", "XRocket")), "top");
		
		
		// OpenRocket version info + copyright
		sub = new JPanel(new MigLayout("fill"));
		
		sub.add(new StyledLabel("XRocket", 20), "ax 50%, growy, wrap para");
