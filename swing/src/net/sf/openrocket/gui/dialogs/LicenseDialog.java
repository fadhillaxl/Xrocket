...
public class LicenseDialog extends JDialog {
	...
	public LicenseDialog(JFrame parent) {
        ...
        /* GPL:  overall project                                                                                                     */
		/*****************************************************************************************************************************/
		final String orLicense = "<strong>GNU GENERAL PUBLIC LICENSE XRocket</strong>" + "<br>" +
			"<br>" +
			"XRocket - A model rocket simulator<br>" + 
			"Copyright " + Chars.COPY + " 2007-" + copyrightYear + " IHUB Sampo Niskanen and others<br>" +
